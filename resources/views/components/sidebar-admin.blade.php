...
<aside class="w-64 bg-slate-900 text-white min-h-screen flex flex-col justify-between sticky top-0 shadow-2xl z-50 shrink-0">
    {{-- TOP: Logo + Brand --}}
    <div>
        <div class="px-6 py-6 border-b border-slate-800">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 group">
                <div class="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-900/40 group-hover:scale-105 transition-transform">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4.5 h-4.5 w-5 h-5 text-white">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487z" />
                    </svg>
                </div>
                <div>
                    <img src="{{ asset('images/logo.png') }}" alt="ChoiATK Logo" class="h-7 sm:h-10 w-auto">
                    <span class="text-[10px] text-slate-500 font-medium tracking-wider uppercase pl-7">Admin Panel</span>
                </div>
            </a>
        </div>
    ...
    <div class="p-4 border-t border-slate-800">
        <div class="flex items-center gap-3 px-2 py-2 rounded-xl hover:bg-slate-800 transition group cursor-default">
            ...
            <div x-data="{ openLogoutModal: false }" class="shrink-0">
                ...
                {{-- 1. Tombol Ikon Pemicu (Hanya Ikon SVG) --}}
                <button type="button"
