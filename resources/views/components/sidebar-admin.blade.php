{{-- Premium Dark Sidebar — Desktop: static flex item | Mobile: drawer overlay --}}
<div x-data="{ sidebarOpen: false }"
    ...
    ══════════════════════════════════════════════════ --}}
    <aside class="hidden lg:flex flex-col w-64 h-full bg-slate-900 text-white shrink-0 shadow-sm overflow-y-auto">
    ...
    <div class="lg:hidden">
        ...
        <aside x-show="sidebarOpen"
               ...
               class="fixed inset-y-0 left-0 w-64 flex flex-col bg-slate-900 text-white shadow-2xl z-50"
               style="display:none;">
            @include('components.sidebar-admin-content')
        </aside>
    </div>
