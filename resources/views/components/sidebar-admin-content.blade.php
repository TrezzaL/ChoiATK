{{-- Shared admin sidebar content — used by both desktop and mobile drawer --}}
<div class="flex flex-col h-full">
    {{-- TOP: Logo + Brand --}}
    <div class="px-6 py-6 border-b border-slate-800 flex items-center justify-between shrink-0">
    ...
    {{-- Navigation Menu --}}
    <nav class="px-3 py-5 space-y-0.5 flex-1 overflow-y-auto">
    ...
    <div class="mt-auto p-4 border-t border-slate-800 shrink-0">
