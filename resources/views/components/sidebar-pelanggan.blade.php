{{-- Premium Pelanggan Sidebar — Tema Landing Page (White + Blue) --}}
<aside class="w-64 bg-white border-r border-slate-100 min-h-screen flex flex-col justify-between sticky top-0 shadow-sm z-50 shrink-0">
